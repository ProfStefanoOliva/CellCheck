...
def test_report_localization_keys_exist_for_all_supported_languages() -> None:
    keys = [
        ...
        "report.save",
        "report.export",
        "report.technical_title",
        "report.prepare_txt",
        "report.save_txt",
        "report.export_tooltip",
        "report.editor_description",
        "report.saved_title",
        "report.export_success",
        "report.export_error_title",
        "report.export_error_message",
        "report.empty_title",
        "report.empty_confirm",
        "report.none_available",
